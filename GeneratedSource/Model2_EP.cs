...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.4.2203.202 at 1:16 PM on Monday, December 5, 2022.
	/// </remarks>
	public partial class Model2_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool9_marginal' from Variable factor
			this.vbool9_marginal_F = VariableOp.MarginalAverageConditional<Bernoulli>(vbool9_use_B, vBernoulli8, this.vbool9_marginal_F);
			Bernoulli vBernoulli9 = Bernoulli.Uniform();
			...
			// Message to 'vbool11' from Or factor
			vbool11_F = BooleanOrOp.OrAverageConditional(vBernoulli8, vBernoulli9);
			...
			vbool13_F = BooleanOrOp.OrAverageConditional(vbool11_F, vBernoulli9);
